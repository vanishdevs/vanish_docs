---
description: >-
  A connection queue that holds players in line when the server is full and lets
  them in by priority. Discord roles, grace periods and a clean queue card are
  all built in.
icon: people-line
---
